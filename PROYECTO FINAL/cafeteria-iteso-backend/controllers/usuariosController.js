...
const crearUsuario = (req, res) => {
    const { nombre, expediente, email, password,rol } = req.body;
    ...
    db.query(buscarEmail, [email], (err, resultados) => {
      ...
      const insertarUsuario = `
        INSERT INTO usuarios (nombre, expediente, email, rol, estado, contraseña)
        VALUES (?, ?, ?, ?, 'activo', ?)
      `;
      
  
      db.query(insertarUsuario, [nombre, expediente, email, rol, password], (err2) => {
...
module.exports = { obtenerUsuarios, loginUsuario,crearUsuario };
